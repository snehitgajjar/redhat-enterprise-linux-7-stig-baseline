control "V-204540" do
  title 'The Red Hat Enterprise Linux operating system must generate audit records for all unsuccessful account access
    events.'
...
account access events occur.
  ...
  tag 'satisfies': %w(SRG-OS-000392-GPOS-00172 SRG-OS-000470-GPOS-00214 SRG-OS-000473-GPOS-00218)
  tag 'gid': 'V-204540'
  tag 'rid': 'SV-204540r505924_rule'
