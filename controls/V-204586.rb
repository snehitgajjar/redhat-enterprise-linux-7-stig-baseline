control "V-204586" do
  ...
  desc 'Without protection of the transmitted information, confidentiality and integrity may be compromised because
    ...
    which information can be transmitted (e.g., servers, mobile devices, notebook computers, printers, copiers, scanners,
    and facsimile machines). Communication paths outside the physical protection of a controlled boundary are exposed to the
    possibility of interception and modification.
    Protecting the confidentiality and integrity of organizational information can be accomplished by physical means (e.g.,
    employing physical distribution systems) or by logical means (e.g., employing cryptographic techniques). If physical
    means of protection are employed, then logical means (cryptography) do not have to be employed, and vice versa.'
  desc  "rationale", ""
  desc  "check", "
...
following command:
  ...
  tag 'satisfies': %w(SRG-OS-000423-GPOS-00187 SRG-OS-000423-GPOS-00188 SRG-OS-000423-GPOS-00189
    SRG-OS-000423-GPOS-00190)
  tag 'gid': 'V-204586'
  tag 'rid': 'SV-204586r505924_rule'
  tag 'stig_id': 'RHEL-07-040310'
  tag 'fix_id': 'F-4710r88951_fix'
  tag 'cci': %w(CCI-002421 CCI-002422 CCI-002418 CCI-002420)
