control "V-204456" do
  title 'The Red Hat Enterprise Linux operating system must be configured so that the x86 Ctrl-Alt-Delete key sequence
    is disabled in the Graphical User Interface.'
  desc 'A locally logged-on user who presses Ctrl-Alt-Delete, when at the console, can reboot the system. If
    accidentally pressed, as could happen in the case of a mixed OS environment, this can create the risk of short-term loss
    of availability of systems due to unintentional reboot. In the graphical environment, risk of unintentional reboot from
    the Ctrl-Alt-Delete sequence is reduced because the user will be prompted before any action is taken.'
  desc  "rationale", ""
  desc  "check", "
...
with the following command:
  ...
  tag 'gid': 'V-204456'
  tag 'rid': 'SV-204456r505924_rule'
  tag 'stig_id': 'RHEL-07-020231'
  tag 'fix_id': 'F-4580r297481_fix'
  tag 'cci': ["CCI-000366"]
  tag nist: ["CM-6 b"]
