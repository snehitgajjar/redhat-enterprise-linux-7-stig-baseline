control "V-204508" do
  title 'The Red Hat Enterprise Linux operating system must label all off-loaded audit logs before sending them to the
    central log server.'
  desc 'Information stored in one location is vulnerable to accidental or incidental deletion or alteration.
    ...
    audit logs are not labeled before they are sent to a central log server, the audit data will not be able to be analyzed
    and tied back to the correct system.'
  desc  "rationale", ""
  desc  "check", "
...
\"name_format\" option:
  ...
  tag 'gid': 'V-204508'
  tag 'rid': 'SV-204508r505924_rule'
  tag 'stig_id': 'RHEL-07-030211'
  tag 'fix_id': 'F-4632r499403_fix'
  tag 'cci': ["CCI-001851"]
  tag nist: ["AU-4 (1)"]
