control "V-204503" do
  title 'The Red Hat Enterprise Linux operating system must be configured so that auditing is configured to produce
    records containing information to establish what type of events occurred, where the events occurred, the source of the
    events, and the outcome of the events. These audit records must also identify individual identities of group account
    users.'
...
information to establish when (date and time) the events occurred.
  ...
  tag 'gid': 'V-204503'
  tag 'rid': 'SV-204503r505924_rule'
  tag 'stig_id': 'RHEL-07-030000'
  tag 'fix_id': 'F-4627r499421_fix'
  tag 'cci': %w(CCI-000131 CCI-000126)
