control "V-219059" do
  ...
  tag 'gid': 'V-219059'
  tag 'rid': 'SV-219059r505924_rule'
  tag 'stig_id': 'RHEL-07-020111'
  tag 'fix_id': 'F-17871r499415_fix'
  ...
  tag 'ia_controls': nil
  tag 'check': 'Note: If the operating system does not have a graphical user interface installed, this requirement is
    Not Applicable.
