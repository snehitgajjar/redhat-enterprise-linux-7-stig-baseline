control "V-204479" do
  title 'The Red Hat Enterprise Linux operating system must be configured so that all system device files are correctly
    labeled to prevent unauthorized modification.'
  desc 'If an unauthorized or modified device is allowed to exist on the system, there is the possibility the system may
    perform unintended or unauthorized operations.'
  desc  "rationale", ""
  desc  "check", "
...
command:
  ...
  tag 'gid': 'V-204479'
  tag 'rid': 'SV-204479r505924_rule'
  tag 'stig_id': 'RHEL-07-020900'
  tag 'fix_id': 'F-4603r88630_fix'
  tag 'cci': %w(CCI-000318 CCI-001814 CCI-001813 CCI-000368 CCI-001812)
