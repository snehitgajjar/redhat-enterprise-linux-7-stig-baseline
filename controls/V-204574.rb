control "V-204574" do
  ...
  desc 'Sending rsyslog output to another system ensures that the logs cannot be removed or modified in the event that
    the system is compromised or has a hardware failure.'
  desc  "rationale", ""
  desc  "check", "
