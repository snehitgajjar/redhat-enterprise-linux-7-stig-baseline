control "V-204598" do
  title 'The Red Hat Enterprise Linux operating system must be configured so that the SSH daemon does not permit Generic
    Security Service Application Program Interface (GSSAPI) authentication unless needed.'
  desc "GSSAPI authentication is used to provide additional authentication mechanisms to applications. Allowing GSSAPI
    authentication through SSH exposes the system's GSSAPI to remote hosts, increasing the attack surface of the system.
...
location of the configuration file, with the ISSO.
  ...
  tag 'gid': 'V-204598'
  tag 'rid': 'SV-204598r505924_rule'
  tag 'stig_id': 'RHEL-07-040430'
  tag 'fix_id': 'F-4722r88987_fix'
  tag 'cci': %w(CCI-000318 CCI-000368 CCI-001812 CCI-001814 CCI-001813)
