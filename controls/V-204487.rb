control "V-204487" do
  ...
  desc 'If a world-writable directory has the sticky bit set and is not group-owned by root, sys, bin, or an application
    Group Identifier (GID), unauthorized users may be able to modify files created by others.
...
following command:
  ...
  tag 'gid': 'V-204487'
  tag 'rid': 'SV-204487r505924_rule'
  tag 'stig_id': 'RHEL-07-021030'
  tag 'fix_id': 'F-4611r499388_fix'
  tag 'cci': ["CCI-000366"]
  tag nist: ["CM-6 b"]
