control "V-204624" do
  title 'The Red Hat Enterprise Linux operating system must not have a graphical display manager installed unless
    approved.'
  desc 'Internet services that are not required for system or application processes must not be active to decrease the
    attack surface of the system. Graphical display managers have a long history of security vulnerabilities and must not be
    used unless approved and documented.'
  desc  "rationale", ""
  desc  "check", "
...
the related packages with the following commands:
  ...
  tag 'gid': 'V-204624'
  tag 'rid': 'SV-204624r505924_rule'
  tag 'stig_id': 'RHEL-07-040730'
  tag 'fix_id': 'F-4748r499412_fix'
  tag 'cci': ["CCI-000366"]
  tag nist: ["CM-6 b"]
