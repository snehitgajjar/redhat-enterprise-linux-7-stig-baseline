control "V-204427" do
  title 'The Red Hat Enterprise Linux operating system must be configured to lock accounts for a minimum of 15 minutes
    after three unsuccessful logon attempts within a 15-minute timeframe.'
...
the configurations listed in this requirement.
  ...
  tag 'gid': 'V-204427'
  tag 'rid': 'SV-204427r505924_rule'
  tag 'stig_id': 'RHEL-07-010320'
  tag 'fix_id': 'F-4551r462529_fix'
