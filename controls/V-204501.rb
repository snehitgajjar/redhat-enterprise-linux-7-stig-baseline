control "V-204501" do
  title 'The Red Hat Enterprise Linux operating system must not allow removable media to be used as the boot loader
    unless approved.'
  desc 'Malicious users with removable boot media can gain access to a system configured to use removable media as the
    boot loader. If removable media is designed to be used as the boot loader, the requirement must be documented with the
...
media or document the configuration to boot from removable media with the ISSO."
  ...
  tag 'gid': 'V-204501'
  tag 'rid': 'SV-204501r505924_rule'
  tag 'stig_id': 'RHEL-07-021700'
  tag 'fix_id': 'F-4625r88696_fix'
  tag 'cci': %w(CCI-000368 CCI-000318 CCI-001813 CCI-001814 CCI-001812)
