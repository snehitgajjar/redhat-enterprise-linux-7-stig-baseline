control "V-204595" do
  title 'The Red Hat Enterprise Linux operating system must be configured so that the SSH daemon is configured to only
    use Message Authentication Codes (MACs) employing FIPS 140-2 approved cryptographic hash algorithms.'
...
location if using a version of SSH that is provided by a third-party vendor):
  ...
  tag 'gid': 'V-204595'
  tag 'rid': 'SV-204595r505924_rule'
  tag 'stig_id': 'RHEL-07-040400'
  tag 'fix_id': 'F-4719r88978_fix'
  tag 'cci': ["CCI-001453"]
  tag nist: ["AC-17 (2)"]
